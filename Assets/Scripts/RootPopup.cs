...
public class RootPopup : UIRoot
{
    public override TypeUI Type => throw new NotImplementedException();
    ...
    [SerializeField] private float alphaMask = 0.9f;
    ...
    {
        AnimateMain(false, () => FadeMask(false));
    }
    #endregion
